...
#Graph N vs K for multiple h
#Perform the corresponding fit to find the relationship
# between N and K
...
#Graphs and fits the Stabilization data (N vs K) for each h
#Param: h Hill coefficient
#Return: Ph slope and y-intercept fit parameters
#Return: graph of N vs K for a given h
def graphSta(h):
...
#Execute code
#Should be execute for the CSV files available for the Stabilization subsection
Ph2=graphSta(2)
Ph23=graphSta(2.3)
Ph27=graphSta(2.7)
Ph3=graphSta(3)
...
#----------------------General Fit----------------------
#Fit that describes the relationship between
# the param of the previous fit and the Hill coefficient (h)
